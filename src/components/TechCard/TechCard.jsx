...
const TechCard = (props) => {
  return (
    <div className='hover:scale-110 transition-all duration-300'> {/* This is the parent div that will be animated when hovered . AOS prevent hover*/  }
        <div data-aos='fade-up' data-aos-anchor-placement='bottom-bottom' className='flex bg-gray-50 shadow-md rounded-2xl md:w-48 w-40 mb-10 mx-4 h-16 items-center'>
